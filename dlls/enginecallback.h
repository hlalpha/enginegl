...
#define SET_SPAWN_PARMS			(*g_engfuncs.pfnSetSpawnParms)
...
#define FIND_ENTITY_IN_RADIUS	(*g_engfuncs.pfnFindRadius)
#define CHECK_CLIENT			(*g_engfuncs.pfnCheckClient)
...
#define CHANGE_METHODS			(*g_engfuncs.pfnChangeMethods)
