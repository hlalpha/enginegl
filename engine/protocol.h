...
#define svc_weaponanim		35		// [byte] sequence
#define svc_decalname		36		// [byte] index [string] decalname
#define svc_roomtype		37		// [short] room_type
